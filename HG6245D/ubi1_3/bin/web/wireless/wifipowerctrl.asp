...
<form method=post name="wifi_power" action="/goform/setWifiPower" onSubmit="return CheckValue('power')">
...
<form method=post name="wifi_power" action="/goform/setWifiConNum" onSubmit="return CheckValue('connum')">
